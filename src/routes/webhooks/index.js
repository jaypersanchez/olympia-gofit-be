...
const endpointSecret = "whsec_fd643be495039e13632d225667b9d313122f3a26a921b23a35bae3e5681e5460";

webhookRoute.post('/collect', express.raw({type: 'application/json'}), (request, response) => {
